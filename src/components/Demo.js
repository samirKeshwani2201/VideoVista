...
const Demo = () => {
    ...
    // When we are changing the theme then it is again calculating the prime number and its a very heavy task so we need to kind of cache it so we use memoization that is we use useMemo
